...
* For each Wikipedia article, if it has parentheses in its title, throw it out unless they contain â€œfilmâ€.
...
* Some info about how the data was made:
    * The script creates 5 quartiles for the field imdbVotes, and writes â€œpopularâ€, â€œunpopularâ€, etc. based on quartile.
